 ...
 *         &lt;element ref="{http://csrc.nist.gov/ns/oscal/1.0}ol"/>
 *         &lt;element ref="{http://csrc.nist.gov/ns/oscal/1.0}ul"/>
 *       &lt;/choice>
...
public class Li {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "ul", namespace = "http://csrc.nist.gov/ns/oscal/1.0", type = Ul.class, required = false),
        ...
        @XmlElementRef(name = "ol", namespace = "http://csrc.nist.gov/ns/oscal/1.0", type = Ol.class, required = false),
